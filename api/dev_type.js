...
+{
    ...
    "startTime": "@date",       // 最新固件日期开始时间
    "endTime": "@date",         // 最新固件日期结束时间：bigint(timeStamp) / null
...
+ {
    ...
    "type_desp": "@string",                 // 设备型号备注: varchar(128)
    "dev_roles": [                          // 角色能力列表
        {
...
+ {
    ...
    "rom_type": {                           // 固件版本（新增或修改）
        "type_name": "@string",             // 固件版本号: varchar(128)
        "type_desp": "@string",             // 升级描述: varchar(128)
        "update_address": "@string",        // 升级地址: varchar(32) 手工输入url TODO 使用上传成功自动生成的地址或者人工填写的地址均可
